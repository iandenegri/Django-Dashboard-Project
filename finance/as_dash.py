...
# Dataframe symbol is just the abbreviation of the company. APPL, YHOO, ETC.
...
def _create_app():
    '''
    Creates the dash application to be rendered.
    '''
    ...
    def update_graph(tickers):
        ...
        for i, ticker in enumerate(tickers):
            try:
                df = DataReader(ticker, 'quandl', dt.datetime(2017,1,1), dt.datetime.now())
            except:
